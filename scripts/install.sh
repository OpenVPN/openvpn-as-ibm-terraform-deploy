...
install_rpm() {
    ...
    yum -y install "https://packages.openvpn.net/as-repo-${DIST}${RELEASE}.rpm" || repo_error
...
usage() {
    echo "Usage: install.sh [-y|--yes] [--without-dco] [-h|--help] [-v|--version]"
    echo
